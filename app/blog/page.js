...
export const metadata = {
  ...
  description: 'Deep dives, dev guides, and reflections. Researched before they are written.',
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <p className="text-[15px] text-muted mb-8 max-w-lg">
        Everything I've written, roughly in the order I wrote it. Deep dives, dev guides, and
        some reflections when an idea I ran into turned out more interesting than expected.
      </p>
