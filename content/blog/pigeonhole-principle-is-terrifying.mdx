...
Somewhere, someone is trying to build a compression algorithm that shrinks _every possible file_, no exceptions. That person will fail, and pigeonhole is why.
