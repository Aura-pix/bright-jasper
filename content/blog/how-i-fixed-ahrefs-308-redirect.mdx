...
The health score was 33%. There were 55 errors. Almost half of it were 308 redirects.
...
Cloudflare was set to DNS-only: the grey cloud, not the orange one. That meant Cloudflare was not proxying traffic. If you have cloudflare set to proxy, scroll to the [last section](##If you use cloudflare proxi instead) for your version of the fix.
...
This is something else that could cause the "3xx redirect in sitemap" error message.
...
![Ahrefs site overview showing a 30% health score](/ahrefs-30-site-overview.png)

After: 100% health and 0 errors.

![Ahrefs site overview showing a 100% health score](/ahrefs-100-site-overview.png)

![Ahrefs timeline showing the health score improvement](/ahrefs-timeline-image.png)
